...
fun SharedPreferences.setUserId(userId: String?) {
    edit { it.putString(Constant.PREF_USER_ID, userId) }
}
...
fun SharedPreferences.getUserId(): String? = getString(Constant.PREF_USER_ID, "")
