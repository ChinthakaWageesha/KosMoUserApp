...
import sl.com.eightdigitz.client.apiSupports.models.PromoCode

data class PromoCodeDiscountResponse(
    ...
    @Json(name = "data") @field:Json(name = "data") var data: PromoCode? = null
)
